...
async function handleMessage(phone, text) {
  ...
  if (greetings.some((w) => msg.toLowerCase().includes(w)) || msg === "0") {
    session.step = "main";
    return `שלום! 👋 ברוך הבא לשירות הלקוחות של פיט פאן - נעלי בית בוטיק בייצור ישראלי\n\nאיך אפשר לעזור לכם היום?\n\n1️⃣ בדיקת סטטוס הזמנה\n2️⃣ החזרות והחלפות\n3️⃣ דיבור עם נציג אנושי\n\nשלח את המספר הרצוי\n\n⏰ שעות פעילות שירות הלקוחות: א׳-ה׳ 10:00-18:00`;
  }
